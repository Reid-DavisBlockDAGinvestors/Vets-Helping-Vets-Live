...
const AdminSubmissions = dynamic(()=>import('@/components/AdminSubmissions'), { ssr: false })
          ...
          <div className="mt-3 space-y-2 text-xs">
            <div className="grid md:grid-cols-2 gap-2">
              ...
              >
                ...
                <option value="0x7354aaA7d71432868C90fc58f95D7bCd6c3F6cb9">Third (current)</option>
              </select>
              <input
                className="rounded bg-white/10 p-2"
