[dotenv@17.2.3] injecting env (23) from .env.local -- tip: =ƒæÑ sync secrets across teammates & machines: https://dotenvx.com/ops
...
library Math {
    ...
    function sqrt(uint256 a) internal pure returns (uint256) {
        ...
        // GåÆ `sqrt(2**k) <= sqrt(a) < sqrt(2**(k+1))`
        // GåÆ `2**(k/2) <= sqrt(a) < 2**((k+1)/2) <= 2**(k/2 + 1)`
        //
...
// File contracts/PatriotPledgeNFTV3.sol
